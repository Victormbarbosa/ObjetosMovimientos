...
public class InterfazPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 172, 150, 67));

        jButton3.setText("Nuevo Examen ");
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 269, 150, 67));
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 369, 150, 67));
